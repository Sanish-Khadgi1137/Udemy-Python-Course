...
for question in question_data:  # loop in list of question in "data.py" file
    # variable "question_text" comes from dictionary in data.py
    question_text = question["question"]#we need @@@@@@@@@@@@@@@@@@
    # from daya.py save to "question_answer" which have "answer" key
    question_answer = question["correct_answer"]#we need @@@@@@@@@@@@@@@@@@@@@@@@
    ...
    # adding each "new_question" in question bank created in for loop
